...
//                repos.add(i, repoFB);
                FieldType fieldType = FieldType.fieldTypeFor(fieldHolder.receiverType.getTypeName().toString() + Constants.FLATBUFFER_INJECT_SUFFIX);
                builder.addStatement("$T obj=new $T()", fieldType.getTypeName(), fieldType.getTypeName());
